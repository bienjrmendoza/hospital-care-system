...
<div class="admin-btn admin-dashboard d-flex gap-3 flex-column flex-lg-row">
    ...
    <a class="bg-primary text-white secondary-hover w-100 text-center" href="{{ route('admin.vitals.index') }}"><i class="fa-solid fa-file-export"></i> Generate PDF</a>
</div>
@endsection
