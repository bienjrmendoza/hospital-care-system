...
<div class="row justify-content-center">
    ...
    <div class="col-md-6">
        <div class="login contact-form card">
            ...
            <form method="POST" action="{{ route('login.store') }}" id="submit-disable">
                ...
                <button class="bg-primary text-white button secondary-hover mb-3" type="submit" id="submit-btn">Sign in <i class="fa-solid fa-arrow-right"></i></button>
                <div class="dont-have">
                    <p class="mb-0">Don't have an account? <a class="text-primary" href="{{ route('register') }}">Register now</a></p>
                </div>
            </form>
        </div>
    </div>
